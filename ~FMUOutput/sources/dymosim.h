...
LIBDS_API int dymosimMainModelWCallbacks(int argc, char *argv[], const struct DymosimModel*f, const struct DymosimCallBacks*);
...
LIBDS_API int DymosimExitInitialize(struct DymosimSimulator*);
/* Perform exit intitialization tasks */
...
LIBDS_API void DymosimSetStoreIncrement(struct DymosimSimulator* sim, double d);
#ifdef __cplusplus
}
#endif
#endif
