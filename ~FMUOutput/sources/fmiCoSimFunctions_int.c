...
extern void declareNew2_(double*, double*, double*, double*, void**,int*, int, struct DeclarePhase*);
DYMOLA_STATIC FMIStatus fmiResetSlave_(FMIComponent c)
{
	...
	switch (comp->mStatus) {
		...
		case modelTerminated:
			...
			declareNew2_(comp->states, comp->parameters, comp->inputs, comp->statesNominal, (void**) comp->tsParameters, &QiErr, 0, 0);
