...
DYMOLA_STATIC void DYNJPopMarkMarks(struct DYNFunctionData_*);
DYMOLA_STATIC MarkObject DYNJPushMark(struct DYNFunctionData_*);
DYMOLA_STATIC void DYNJRePushMark(MarkObject*, struct DYNFunctionData_*);
DYMOLA_STATIC void DYNJRelease(struct DYNFunctionData_*); /* Release: used after each matrix assignment in the function */
DYMOLA_STATIC void DYNJPopMark(MarkObject oldMark, struct DYNFunctionData_*);
#endif
