...
<br/><p>Copyright &copy; 2014 Marek Matejak, Charles University in Prague.</p><br/>
    ...
    package Test
      model AmmoniumExcretion
        ...
        Physiolibrary.Types.Constants.pHConst pH(k=7.4)   annotation(Placement(transformation(extent = {{-65.25, 74}, {-47.25, 88}}, origin = {-2.75, 2}, rotation = 0), visible = true));
        ...
        Physiolibrary.Types.Constants.FractionConst fAld(k = 1) annotation(Placement(transformation(extent={{-92,-60},
                  {-84,-52}})));
        pHUrine pHUrine1 annotation(Placement(transformation(extent = {{28, -68}, {68, -34}})));
        ...
        Physiolibrary.Types.Constants.VolumeFlowRateConst GFR(k(displayUnit = "l/min") = 1.6666666666667e-06) annotation(Placement(transformation(extent = {{-8, -7}, {8, 7}}, rotation = 180, origin = {90, -10}), visible = true));
        ...
        pHUrine_New pHUrine_New1
          annotation (Placement(transformation(extent={{98,-80},{130,-44}})));
      equation
        connect(pH.y, busConnector.pH_art) annotation(Line(points = {{-47.75, 81}, {2, 81}, {2, 58}, {24, 56}}, color = {0, 0, 127}, visible = true, origin = {0, 2}), Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}));
        ...
        connect(pHUrine1.PhosphateConc, Phosphate.y) annotation(Line(visible = true, origin = {36.2, -2.015}, points = {{12.2, -35.045}, {12.2, 12.015}, {-12.2, 12.015}, {-12.2, 11.015}}, color = {0, 0, 127}));
        connect(OrgAnions.y, pHUrine1.OrgAnionsConc) annotation(Line(visible = true, origin = {32.906, -25.86}, points = {{-10.906, 10.86}, {3.906, 10.86}, {3.906, -10.86}, {3.094, -10.86}}, color = {0, 0, 127}));
        connect(GFR.y, pHUrine1.GlomerularFiltration) annotation(Line(visible = true, origin = {66.03, -23.53}, points = {{13.97, 13.53}, {-4.37, 13.53}, {-4.37, -13.53}, {-5.23, -13.53}}, color = {0, 0, 127}));
        connect(pHUrine1.pHa, pH.y) annotation(Line(visible = true, origin={-9.358,
                -23.473},                                                                       points={{40.958,
                -31.947},{29.358,-31.947},{29.358,-62.527},{-30.642,-62.527},{
                -30.642,106.473},{-38.392,106.473}},                                                                                                    color = {0, 0, 127}));
        connect(titratableAcid.pHa, pH.y) annotation(Line(visible = true, origin = {-40.201, 23.08}, points = {{7.146, -59.92}, {0.201, -59.92}, {0.201, 59.92}, {-7.549, 59.92}}, color = {0, 0, 127}));
        connect(titratableAcid.TA, pHUrine1.TA) annotation(Line(visible = true, origin = {17.874, -46.41}, points = {{-10.189, -2.21}, {-1.769, -2.21}, {-1.769, 2.21}, {13.726, 2.21}}, color = {0, 0, 127}));
        ...
        connect(pHUrine_New1.GlomerularFiltration, GFR.y) annotation (Line(
              points={{124.24,-47.24},{124.24,-24},{60,-24},{60,-10},{80,-10}},
              color={0,0,127}));
        connect(pHUrine_New1.PhosphateConc, Phosphate.y) annotation (Line(
              points={{114.32,-47.24},{114.32,-28},{48,-28},{48,9},{24,9}},
              color={0,0,127}));
        connect(pHUrine_New1.OrgAnionsConc, OrgAnions.y) annotation (Line(
              points={{104.4,-46.88},{104.4,-30},{36,-30},{36,-15},{22,-15}},
              color={0,0,127}));
        connect(pHUrine_New1.pHa, pH.y) annotation (Line(points={{100.88,-66.68},
                {90,-66.68},{90,-88},{-40,-88},{-40,84},{-40,83},{-47.75,83}},
              color={0,0,127}));
        connect(titratableAcid.TA, pHUrine_New1.TA) annotation (Line(points={{
                7.685,-48.62},{12,-48.62},{12,-68},{80,-68},{80,-54.8},{100.88,
                -54.8}}, color={0,0,127}));
        connect(pHUrine_New1.pHu, titratableAcid.pHu) annotation (Line(points={
                {130,-59.84},{138,-59.84},{138,-60},{138,-96},{128,-96},{128,
                -88},{-50,-88},{-50,-47.48},{-33.055,-47.48}}, color={0,0,127}));
        connect(pHUrine_New1.NH4exretion, ammonium.molarflowrate) annotation (
            Line(points={{100.24,-75.32},{96,-75.32},{96,-80},{146,-80},{146,
                72.8},{88.44,72.8}}, color={0,0,127}));
