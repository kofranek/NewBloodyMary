  ...
  package Package
    ...
    model BloodResistor
      ...
      Physiolibrary.Hydraulic.Components.Resistor resistor(Resistance=
            bloodResistance)
        annotation (Placement(transformation(extent={{-12,-5},{8,15}})));
